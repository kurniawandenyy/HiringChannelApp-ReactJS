            ...
            <Navbar bg="light" expand="lg" style={{ borderBottom: '3px solid #DADADA' }}>
                ...
                <Navbar.Toggle aria-controls="basic-navbar-nav" />
                    <Navbar.Collapse className="ml-2" id="basic-navbar-nav">
                        ...
                        <Nav.Link className="ml-5 mr-3 mt-2" href="/"><FontAwesomeIcon icon={faUserCircle} size="lg" /> {this.props.user}</Nav.Link> 
                            ...
                            <Nav.Link className="ml-3 mt-2" href="/login"><FontAwesomeIcon icon={faSignInAlt} size="lg" /></Nav.Link>
                        </Nav></Col>
                    </Navbar.Collapse>
            </Navbar>
            </>
